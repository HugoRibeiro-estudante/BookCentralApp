    ...
    return (
        <div style={navMenuStyle.container}>
            <div style={navMenuStyle.nav}>
                <a href="/newbook"><img src={Book} alt="" style={activeChild === 1 ? navMenuStyle.active : navMenuStyle.img} /></a>
                <a href="#"><img src={Rank} alt="" style={activeChild === 2 ? navMenuStyle.active : navMenuStyle.img} /></a>
                <a href="/home"><img src={Home} alt="" style={activeChild === 3 ? navMenuStyle.active : navMenuStyle.img} /></a>
                <a href="/profile"><img src={User} alt="" style={activeChild === 4 ? navMenuStyle.active : navMenuStyle.img} /></a>
            </div>
        </div>
    );
};
